...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CommandEntityPostIntent'] ?? $this->getCommandEntityPostIntentService());
        }, 1 => 'initializePaymentIntent'], 63);
        $instance->addListener('kernel.view', [0 => function () {
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Entity/ShoppingCart.php';

        return $this->privates['.errored..service_locator.B_xsg_v.App\\Entity\\ShoppingCart'] = new \App\Entity\ShoppingCart();
    }
    ...
    /**
     * Gets the private 'App\EventSubscriber\CommandEntityPostIntent' shared autowired service.
     *
     * @return \App\EventSubscriber\CommandEntityPostIntent
     */
    protected function getCommandEntityPostIntentService()
    {
        include_once \dirname(__DIR__, 4).'/src/EventSubscriber/CommandEntityPostSubscriber.php';

        return $this->privates['App\\EventSubscriber\\CommandEntityPostIntent'] = new \App\EventSubscriber\CommandEntityPostIntent(($this->privates['App\\Services\\CommandService'] ?? $this->getCommandServiceService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
