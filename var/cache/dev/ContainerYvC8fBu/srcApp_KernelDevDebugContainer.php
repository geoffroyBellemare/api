...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CommandItemEntitySubscriber'] ?? $this->getCommandItemEntitySubscriberService());
        }, 1 => 'setCommandItems'], 33);
        $instance->addListener('kernel.view', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\CommandItemEntitySubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\CommandItemEntitySubscriber
     */
    protected function getCommandItemEntitySubscriberService()
    {
        include_once \dirname(__DIR__, 4).'/src/EventSubscriber/CommandItemEntitySubscriber.php';
        include_once \dirname(__DIR__, 4).'/vendor/stripe/stripe-php/lib/Stripe.php';
        include_once \dirname(__DIR__, 4).'/src/Security/StripeService.php';

        return $this->privates['App\\EventSubscriber\\CommandItemEntitySubscriber'] = new \App\EventSubscriber\CommandItemEntitySubscriber(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Security\\StripeService'] ?? ($this->privates['App\\Security\\StripeService'] = new \App\Security\StripeService($this->getEnv('S_SECRET'), 'http://localhost:8000/'))));
    }
