...
class srcApp_KernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5xDGSQXBKX', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PzjqjfceMz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \App\Serializer\UserAttributeNormalizer(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService())), 1 => new \ApiPlatform\Core\Bridge\RamseyUuid\Serializer\UuidDenormalizer(), 2 => $g, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($d, [], $h), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $h), 5 => $g, 6 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($a, $b, $c, $i, NULL, $d, $e, $h), 7 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($a, $j, $d), 8 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($d, false), 9 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(false), 10 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 11 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($a, $b, $c, $j, $i, $k, $l, $h, $m, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), false), 12 => new \ApiPlatform\Core\Serializer\ItemNormalizer($b, $c, $j, $i, $l, $h, $m, ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $a, false), 13 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $h), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 19 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($k, $i, $j), 'page', 'pagination', $a, $l), $a, $i, $f), 20 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 21 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($n, $j, $k), 22 => $n], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Endroid\QrCodeBundle\Twig\QrCodeExtension(($this->privates['Endroid\\QrCode\\Factory\\QrCodeFactory'] ?? $this->getQrCodeFactoryService()), $c));
    ...
    protected function getUserConfirmationSubscriberService()
    {
        ...
        return $this->privates['App\\EventSubscriber\\UserConfirmationSubscriber'] = new \App\EventSubscriber\UserConfirmationSubscriber(new \App\Security\UserConfirmationService(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kgr28NWFvw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6lVik1YKm8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xkQtalfzNQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OmJ7uRBHiR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zsWSJG81Vz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rbOLQdXI13', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pf0ZlzMPiZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('D41eddhxUI', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xJRORjgCI1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rFG649CFmO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6GzBxfvFKx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lbz9JSHTMc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getConsole_Command_CachePoolListService()
    {
        ...
        $this->privates['console.command.cache_pool_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolListCommand([0 => 'cache.app', 1 => 'cache.system', 2 => 'cache.validator', 3 => 'cache.serializer', 4 => 'cache.annotations', 5 => 'cache.property_info', 6 => 'doctrine.result_cache_pool', 7 => 'doctrine.system_cache_pool', 8 => 'cache.property_access', 9 => 'cache.security_expression_language', 10 => 'cache.easyadmin', 11 => 'api_platform.cache.route_name_resolver', 12 => 'api_platform.cache.identifiers_extractor', 13 => 'api_platform.cache.subresource_operation_factory', 14 => 'api_platform.cache.metadata.resource', 15 => 'api_platform.cache.metadata.property']);
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mwkkYWBsFp', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LTd6YsaPMU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
