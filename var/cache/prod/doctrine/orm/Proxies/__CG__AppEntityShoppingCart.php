...
class ShoppingCart extends \App\Entity\ShoppingCart implements \Doctrine\ORM\Proxy\Proxy
{
  ...
  'executingCommand' => NULL,
    ...
    {
        unset($this->customer, $this->items, $this->executingCommand);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'customer', 'items', '' . "\0" . 'App\\Entity\\ShoppingCart' . "\0" . 'totalAmount', 'executingCommand'];
        }

        return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entity\\ShoppingCart' . "\0" . 'totalAmount'];
    }
