 ...
 */
class ShoppingCartItem extends \App\Entity\ShoppingCartItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'command' => NULL,
    ...
    {
        unset($this->cart, $this->prestation, $this->quantity, $this->totalAmount, $this->startTime, $this->endTime, $this->command);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cart', '' . "\0" . 'App\\Entity\\ShoppingCartItem' . "\0" . 'checkOutSessionID', 'prestation', 'quantity', 'totalAmount', 'startTime', 'endTime', 'command'];
        }

        return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entity\\ShoppingCartItem' . "\0" . 'checkOutSessionID'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ShoppingCartItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getCommand(): ?\App\Entity\Command
    {
